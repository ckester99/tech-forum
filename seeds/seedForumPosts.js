...
const seedForumPosts = async () => {
    await ForumPost.bulkCreate([
        { id: 1, title: "TestTitle 1", content: "TestContent1", user_id: 1, timestamp: new Date(2023, 0, 24, 12, 1, 1) },
        { id: 2, title: "TestTitle 2", content: "TestContent2", user_id: 2, timestamp: new Date(2023, 0, 24, 13, 2, 2) },
        { id: 3, title: "TestTitle 3", content: "TestContent3", user_id: 3, timestamp: new Date(2023, 0, 24, 14, 3, 3) },
